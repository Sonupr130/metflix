      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex justify-center mb-8">
          <div className="text-3xl font-bold text-white">
            <span className="text-red-500">MEFLIX</span> Admin
          </div>
        </div>
        ...
        <p className="text-center text-white/70 text-sm mt-6">
          &copy;{new Date().getFullYear()} Metflix Admin Dashboard | <span className='cursor-pointer hover:text-blue-500' onClick={() =>navigate('/')}>Back to Home</span>
        </p>
      </div>
    </div>
  );
